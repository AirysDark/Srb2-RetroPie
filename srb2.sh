...
rp_module_id="srb2"
rp_module_desc="Sonic Robo Blast 2 - 3D Sonic the Hedgehog fan-game based on Sonic Robo Blast 2 built using a modified version of the Doom Legacy source port of Doom"
...
function sources_srb2() {
    ...
    downloadAndExtract "https://github.com/AirysDark/Srb2-RetroPie-Update/releases/download/srb2/srb2-assets.tar" "$md_build"
}
...
function install_srb2() {
    ...
    md_ret_files=(
        'assets/installer/'
        'assets/installer/models/'
        'assets/installer/models/BOSS/'
        'assets/installer/models/ENMY/'
        'assets/installer/models/OBJE/'
        'assets/installer/models/PLAY/'
        'assets/'
    )
}
